...
const optionalWebsiteCheck = (value) => {
    if (value.trim() === "") {
        return true;
    } else {
...
export {
    ...
    optionalWebsiteCheck, optionalTextcheck, optionalMiddleInitialCheck,optionalCityStateCheck, optionalAddressCheck, optionalZipCheck,optionalPhoneCheck, optionalEmailCheck,
    checkboxCheck
}
