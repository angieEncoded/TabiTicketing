...
const Contact = db.define('contact', {
    ...
    // computer_password: {type: Sequelize.TEXT, allowNull:true},
    // email_password: {type: Sequelize.TEXT, allowNull:true},
    // other_password: {type: Sequelize.TEXT, allowNull:true},
