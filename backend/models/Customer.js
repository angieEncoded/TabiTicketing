...
module.exports = class Customer {
    ...
    static findById(id) {
        return db.execute("select * from customers where id = ?", [id]);
    }

    save() {
        return db.execute(`insert into customers (
            uuid,
            customer_name,
            primary_phone,
            fax,
    ...
    updateCustomer() {
        return db.execute(`update customers set
        customer_name = ?,
        primary_phone = ?,
        fax = ?,
        secondary_phone = ?,
